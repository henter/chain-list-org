...
function Home({ changeTheme, theme }) {
  ...
  const handleLayoutChanged = (event, newVal) => {
    if(newVal !== null) {
      setLayout(newVal)
      localStorage.setItem('chain-list-invest-layout', newVal ? newVal : '')
    }
  }
          ...
          <div className={ classes.copyContainer }>
            <div className={ classes.copyCentered }>
              ...
              <div className={ classes.socials }>
                <a className={ `${classes.socialButton}` } href='https://github.com/henter/chain-list-org' target='_blank' rel="noopener noreferrer" >
              ...
              <div className={classes.socials}>
                <a className={`${classes.socialButton}`} href='https://twitter.com/henterchow' target='_blank' rel="noopener noreferrer" >
                  ...
                  <Typography variant='body1' className={classes.sourceCode}>Follow</Typography>
                </a>
              </div>
            </div>
          </div>
